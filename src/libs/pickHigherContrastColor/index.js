 ...
 */
export const pickHigherContrastColor = (optionA, optionB, background) => {
    ...
    const ratioA = getContrastRatio(bgLum, a.luminance);
    const ratioB = getContrastRatio(bgLum, b.luminance);
