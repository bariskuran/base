 ...
 *
 * It can auto-detect the input case (best-effort) and then convert into the desired output case.
 ...
 * - If `output` is unknown, it returns a string like `"undefined output > ${output}"`.
 *
 * @param {string} string - The input string to convert.
 * @param {"camel"|"pascal"|"kebab"|"snake"|"constant"|"dot"|"path"|"lower"|"sentence"|"title"|"spaced"} [output="camel"]
 *        The desired output case format.
 * @param {"auto"|"camel"|"pascal"|"kebab"|"snake"|"constant"|"dot"|"path"|"lower"|"sentence"|"title"|"spaced"} [input="auto"]
 *        The input case format. Use "auto" to let the function try to infer it.
 *
 ...
 *
 * @example
 * // Explicit input (skip auto-detection)
...
export const stringCaseConverter = (string, output = "camel", input = "auto") => {
    ...
    switch (output) {
        ...
        default:
            return "undefined output > " + output;
    }
};
