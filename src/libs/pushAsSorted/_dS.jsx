...
const X = () => (
    <Ds.page title="<pushAsSorter>" releasedOn="1.0.0" description="Pushes and sorts with neighbor info.">
        <Ds.block
            title="Basic Usage"
...
const [sorted, index, lower, upper] = pushAsSorted([5, 1, 3], 4);`}
        ...
        <Ds.api
            props={{
                arr: { description: "Input array.", type: "any[]", required: false, defaultValue: "[]" },
                el: { description: "Element to push.", type: "any", required: false, defaultValue: "0" },
                return: {
